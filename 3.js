...
class Cajero {
    ...
    mostrarEstadoCompra(cliente, comboNombres, salaPelicula, cine, asientos) {
        ...
        // Solo se resta el precio del primer combo
    ...
    realizarCompra(cliente, comboNombres, salaPelicula, cine, asientos) {
        ...
        for (let comboNombre of comboNombres) {
            ...
            puntosRegaloTotal += combo.puntos_regalo; // Asegúrate de sumar los puntos de regalo
        }
...
class Boleta {
    ...
    generarBoleta() {
        ...
        // Detalles del costo de los asientos
        ...
        // Solo restar el precio del primer combo
        let primerComboPrecio = 0;

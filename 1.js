...
class Cine {
    ...
    eliminarPelicula(nombreSala) {
        if (this.salas[nombreSala]) {
            delete this.salas[nombreSala];
            console.log("Película eliminada de la sala: " + nombreSala);
        } else {
            console.log("Sala no encontrada: " + nombreSala);
        }
    }

    agregarCombo(nombreCombo, nombre, precio, costopuntos, puntos_regalo) {
        this.combos[nombreCombo] = {
            nombre: nombre,
            precio: precio,
    ...
    eliminarCombo(nombreCombo) {
        if (this.combos[nombreCombo]) {
            delete this.combos[nombreCombo];
            console.log("Combo eliminado: " + nombreCombo);
        } else {
            console.log("Combo no encontrado: " + nombreCombo);
        }
    }
...
let comboNombres = ["combo1", "combo2","combo3"];
